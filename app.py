...
st.info("""Бот отвечает на вопросы пользователей MaxPatrol SIEM 27.6, используя только официальную документацию. С пруфами.  \nБот работает в тестовом режиме на движке LLama. Чтобы не перегрузить бота запросами:  - Не задавайте более 3-х вопросов в минуту. - Старайтесь формулировать запрос конкретно (например, не "агенты", а "как установить агент в Linux"). - После завершения работы очищайте историю чата.""")
