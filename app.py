...
st.info("Бот отвечает на вопросы пользователей MaxPatrol SIEM 27.6, используя только официальную документацию. С пруфами.<br>Бот работает в тестовом режиме на движке LLama. Чтобы не перегрузить бота запросами:")
