...
if prompt := st.chat_input(f"Задать вопрос по MaxPatrol SIEM {selected_ver}..."):
    ...
    with st.chat_message("assistant"):
        ...
        with st.spinner("Llama 3 анализирует документацию..."):
            system_instruction = """
            Ты — эксперт по системе MaxPatrol SIEM. Твоя задача - отвечать на вопросы пользователей, используя документы-источники в PDF. Отвечай ТОЛЬКО по предоставленному контексту. 
