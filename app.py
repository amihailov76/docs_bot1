...
st.info("""Бот отвечает на вопросы по MaxPatrol SIEM 27.6, используя только официальную документацию. С пруфами.  \nВнимание! Ответы генерируются ИИ Llama и могут содержать неточности, ошибки, неверные интерпретации документов. Всегда проверяйте важную информацию самостоятельно в документации.  \nЧтобы не перегрузить бота запросами:  
