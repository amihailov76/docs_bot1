...
if prompt := st.chat_input(f"Задать вопрос по MaxPatrol SIEM {selected_ver}..."):
    ...
    with st.chat_message("assistant"):
        ...
        with st.spinner("Llama 3 анализирует документацию..."):
            system_instruction = """
            ПРАВИЛА:
            1. Сначала проанализируй КОНТЕКСТ. Если в нем есть ответ (даже косвенный), сделай логический вывод.
            2. Если прямого ответа нет, но в контексте есть близкие по смыслу разделы, используй их для ответа, указав, что это логический вывод из документации.
            3. Если информации категорически нет — напиши: "В предоставленной документации не найдено информации о [тема]".
            4. Обязательно добавляй ссылки (SOURCE_...) для подтверждения своих слов.
            """
